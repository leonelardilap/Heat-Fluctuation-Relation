 ...
 * SOURCE  : http://manual.gromacs.org/documentation/current/reference-manual/algorithms/stochastic-dynamics.html
 */
...
int main(void){
	...
	double Ei=3.0, dE=0.005, Xmax=sqrt(2*(Ei+dE)/k), Pmax=sqrt(2*m*(Ei+dE)), Emean=Ei, SumE=0.0;
